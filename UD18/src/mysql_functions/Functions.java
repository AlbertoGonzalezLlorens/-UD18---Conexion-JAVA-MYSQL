...
public class Functions {
	...
	//-------------------------------------------------MODIFICAR REGISTROS--------------------------------------------------------------------
		public void updateRecord(Connection conexion,String db, String table_name, String columna, String nuevo_valor) {
			try {
				String Querydb = "USE "+db+";";
				Statement stdb = conexion.createStatement();
				stdb.executeUpdate(Querydb);
				
				String Query = "UPDATE "+table_name+" SET "+columna+"="+nuevo_valor;
				Statement st = conexion.createStatement();
				st.executeUpdate(Query);
